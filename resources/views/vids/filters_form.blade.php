<div class="container-fluid">
	<form class="navbar-form " action={{route("vids.index")}}/setfilter/{{$from}}{{isset($to) ? "/$to" : ""}} method="POST">
		...
		<div class="btn-group">
			<input type="submit" class="btn navbar-btn btn-default {{$show_unchecked == 'true' ? 'ative' : ''}}" aria-pressed="{{$show_unchecked}}" autocomplete="off" name="unchecked" value="@lang('No Vistos')">
